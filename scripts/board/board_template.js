...
function editTaskTemplate(index) {
    ...
    return  `<div class="card_overlay_header">
...
function getAddTaskOverlay() {
    return  `<div onclick="closeOverlay('addTask_overlay')" id="addTask_overlay" class="bg_overlay d_none">
                    ...
                    <div class="container_AddTask_ol"> 
                        <div class="section_left_ol">
                            <div class="section_title_ol">
                                ...
                                <input id="taskTitle" class="input_title_ol input-field" type="text" placeholder="Enter a title" tabindex="1">
                                <span class="error_Field_ol">&nbsp;</span>
                            </div>  
                            <div class="section_description_ol">
                                <h2>Description</h2>
                                <div class="textarea_description_ol">
                                    <textarea id="descriptionTask" class="text_area_ol" placeholder="Enter a Description" tabindex="2"></textarea>
                                </div>
                            </div>
                            <div class="section_assigned_ol">
                                ...
                                <div class="task_input_section_ol">
                                    <input type="text" id="taskDropDownInput" class="task_dropdown_input_ol" tabindex="3" placeholder="Select contacts to assign" onclick="taskContactListDrobdown()" onkeyup="taskContactFilterList()">
                                    <img src="../assets/icons/arrow_down.svg">
                                </div>
                                <div id="taskContactDrowdownMenue" class="task_dropdown_content_ol">
                                    <div id="taskDropDownList" class="task_dropdown_list_ol"></div>
                                </div>
                            </div>
                            <div id="initialeIconList" class="initiale_Icon_List_ol icon_List_hide"></div>
                        </div>
                        <div class="required_text_ol">
                            <span><span class="star_red_ol">*</span class="required-text_ol">This field is requiered</span>
                        </div>
                    </div>
                    <div class="hr_ol"><hr></div>
                        ...
                        <div class="section_subtasks_ol">
                            ...
                            <div class="input_wrapper_ol">
                                <div class="input_group_ol">
                                    <input type="text" id="inputSubtask" class="input_subtasks_ol" oninput="subTaskInputCheck()" maxlength="40">
                                    <img id="subTaskAddIcon" class="add_subtasks_new_ol ele_hide" onclick="subTaskInputCheck(true)" src="../assets/icons/add.png" alt="add-icon">
                                    <div id="subTaskEditIocn" class="add_subtasks_ol sub_Task_Edit_Iocn_ol ele_hide">
                                        <img id="subTaskCloseIcon" onclick="subTaskClose()" src="../assets/icons/close.svg" alt="add-icon">
                                        <img src="../assets/icons/vectorV.svg">
                                        <img id="subTaskCheckIcon" onclick="taskCreateTask()" src="../assets/icons/checkSW.svg" alt="add-icon">
                                    </div>
                                </div>
                                <span class="error_Field_ol">&nbsp;</span>
                            </div>
                            <div id="subTaskList" class="subtask_list_ol"></div>
                        </div>
                        <div class="button_bottom_task_ol">
                            <button id="btnClearTask" class="button-clear-task" onclick="addTaskClear()">Clear <img class="cancel_ol" src="../assets/icons/iconoir_cancel.png" alt=""></button>
                ...
                <div class="button_bottom_task_mobile_ol">
                    <button id="btnClearTask" class="button-clear-task" onclick="addTaskClear()">Clear 
                        <img class="cancel_ol" src="../assets/icons/iconoir_cancel.png" alt="">
                    </button>
                    <button id="btnCreateTask" class="button-create-task" onclick="checkInputData('overlay')">Create Task
                        <img src="../assets/icons/check.png" alt="">
                    </button>
